      ...
      <html>
        <head>
          ...
          <style>
            ...
            .seal { position: absolute; bottom: 20px; left: 50%; transform: translateX(-50%); width: 120px; height: 120px; opacity: 0.1; background: url('/assets/skoola_icon.png') no-repeat center; background-size: contain; filter: grayscale(1); }
        ...
        <body>
          <div class="certificate-container">
            <div class="certificate-inner">
              ...
              <div class="header">
                 <img src="/assets/skoola_icon.png" class="logo" />
              ...
              <div class="content">
                ...
                <div class="description">${reward.description || 'Recognized for outstanding contributions and commitment to the growth of the Skoola ecosystem. Your partnership has been instrumental in our shared success.'}</div>
              ...
              <div class="footer">
                ...
                <div class="signature-block">
                   <div style="font-family: 'Great Vibes', cursive; font-size: 24px; margin-bottom: 5px;">Skoola Admin</div>
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 flex transition-colors duration-200">
      ...
      <aside className="w-64 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hidden lg:flex flex-col transition-colors">
        <div className="p-6 flex items-center gap-3">
          <img src="/assets/skoola_icon.png" alt="Logo" className="w-8 h-8" />
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <span className="px-4 py-2.5 bg-zinc-100 dark:bg-zinc-700 border border-l-0 border-zinc-200 dark:border-zinc-700 rounded-r-xl text-zinc-500 text-sm">.skoola.com</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="p-6 md:p-8 space-y-6 overflow-y-auto">
              ...
              <div className="p-4 rounded-2xl border border-zinc-100 dark:border-zinc-800 space-y-1">
                ...
                <div className="flex items-center justify-between mt-1">
                  <p className="text-sm font-bold text-indigo-600">{selectedSchool.custom_domain ? `${selectedSchool.custom_domain}.skoola.com` : 'No custom domain'}</p>

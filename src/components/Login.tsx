          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 z-10 text-indigo-500 group-focus-within:text-indigo-700 transition-colors pointer-events-none" />
                <input
                  type="text"
                  required
                  autoComplete="off"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 z-10 text-indigo-500 group-focus-within:text-indigo-700 transition-colors pointer-events-none" />
                <input
